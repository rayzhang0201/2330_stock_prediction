...
show_interval = sys.argv[6] # "all" or any integer
...
def precheck():
    if len(sys.argv) < 7:
        info("Usage:")
        info("  python show_test_result.py ${2330_csv_path} [m2o|m2m] [LSTM|GRU] ${past_day} ${future_day} ${show_interval}")
        info("Ex.")
        info("  # python show_test_result.py ./2330_new_csv m2o LSTM 20 1 60")
        info("  # python show_test_result.py ./2330_new_csv m2m GRU 20 5 60")
        sys.exit(1)
